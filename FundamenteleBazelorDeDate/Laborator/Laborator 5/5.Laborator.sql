...
select * from Client where Judet = (select Judet from Client where Nume = 'Tudorescu')

select * from Client where Judet = (select  Judet from  Comanda where Id = 8)

select * from Produs where Pret < (select PretTotal from ProduseComandate  where ID = 17)

select * from Produs where Id = any (select IdProdus from ProduseComandate where Cantitate = 2)

select * from Produs where pret > any (select PretTotal from ProduseComandate where Cantitate >2)

select * from Produs where pret > all (select PretTotal from ProduseComandate where Cantitate >2)

select * from Produs where ID in (1,3,5)

select * from Client where ID in(select IdClient from Comanda)

select * from Client where ID not in(select IdClient from Comanda)

SELECT * FROM Client where Prenume like '%na' -- care se termiona cu na
SELECT * FROM Client where Prenume like '%na%' -- care contine la mijloc na
SELECT * FROM Client where Prenume like 'A%a' -- care incepe cu A si se termina cu a
SELECT * FROM Client where Prenume like '%na' -- care se termina cu na
SELECT * FROM Client where Prenume like '_na' -- inlocuieste primul caracter

select * from Produs

select (min(Pret)) as [Pret Minim] from Produs -- produsul cu pretul cel mai mic
select (max(Pret)) as [Pret Maxim] from Produs -- produsul cu pretul cel mai mare
select (avg(Pret)) as [Pret Medie] from Produs
select (sum(Pret)) as [Pret Suma] from Produs

select count(ID) from Produs where pret > 549.99