...
use Intreprindere
/*
->Script-ul a fost creat in dataGrip si testat in SSMS, aceste a functionat fara nicio problema!:)
->Am folosit comanda GO ca sa fortam serverul SQL sa finalizeze complet crearea bazei de date
inainte de a trece la comanda USE!
*/
...
insert into ACHIZITII(IdAchizitie, IdFurnizor, IdComponenta, IdAchizitor, Data, NrComponente, PretUnitar) values
    (1, 1, 1, 2, '2025-01-10', 50, 250.00),
    (2, 2, 2, 2, '2025-02-15', 100, 75.00),
    (3, 3, 3, 2, '2025-03-20', 80, 120.00),
